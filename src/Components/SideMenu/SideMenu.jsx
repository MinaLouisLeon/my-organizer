...
import {
  ...
  actionSetAllTasks,
  actionSetTasksLinks,
  actionSetAllProjects,
  actionClearOpenProject,
} from "../../actions";
...
const SideMenu = () => {
  ...
  const handleProjects = () => {
    getFromDatabase("Users/" + userUID + "/Projects").then((data) => {
      dispatch(actionSetAllProjects(data));
      dispatch(actionClearOpenProject());
    ...
    <IonMenu contentId="enableSideMenu">
      ...
      <IonContent>
        <IonList>
          ...
          <IonItem button onClick={() => handleProjects()} >
